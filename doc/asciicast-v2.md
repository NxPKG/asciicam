...
Idle time limit, as given via `-i` option to `asciicam rec`. Float.
...
Command that was recorded, as given via `-c` option to `asciicam rec`. String.

#### `title`

Title of the asciicast, as given via `-t` option to `asciicam rec`. String.
...
> Official asciicam recorder captures only `SHELL` and `TERM` by default. All
...
> Official asciicam recorder doesn't capture keyboard input by default. All
> implementations of asciicast-compatible terminal recorder should not capture
...
* [asciicam terminal recorder](https://github.com/khulnasoft-lab/asciicam) - 2.0.0
* [asciicam web player](https://github.com/khulnasoft-lab/asciicam-player) - 2.6.0
* [asciicam server](https://github.com/khulnasoft-lab/asciicam-server) - v20171105
