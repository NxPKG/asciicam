...
- [asciicam/asciicam](https://github.com/khulnasoft-lab/asciicam/issues) - command-line recorder
- [asciicam/asciicam-server](https://github.com/khulnasoft-lab/asciicam-server/issues) - public website hosting recordings
- [asciicam/asciicam-player](https://github.com/khulnasoft-lab/asciicam-player/issues) - player
...
If you believe most asciicam users would benefit from implementing your idea
...
improving an existing one, please first discuss this with asciicam team. You
can simply open a separate issue for a discussion or join #asciicam IRC
channel on Libera.Chat.

## Reporting security issues

If you found a security issue in asciicam please contact us at
admin@asciicam.org. For the benefit of all asciicam users please **do
...
to or verifying responses from admin@asciicam.org.
