...
def main() -> Any:
    if not valid_encoding():
        sys.stderr.write(
            "asciicam needs an ASCII or UTF-8 character encoding to run. "
  ...
  Record terminal and upload it to asciicam.org:
    \x1b[1masciicam rec\x1b[0m
  Record terminal to local file:
    \x1b[1masciicam rec demo.cast\x1b[0m
  Record terminal and upload it to asciicam.org, specifying title:
    \x1b[1masciicam rec -t "My git tutorial"\x1b[0m
  Record terminal to local file, limiting idle time to max 2.5 sec:
    \x1b[1masciicam rec -i 2.5 demo.cast\x1b[0m
  Replay terminal recording from local file:
    \x1b[1masciicam play demo.cast\x1b[0m
  Replay terminal recording hosted on asciicam.org:
    \x1b[1masciicam play https://asciicam.org/a/difqlgx86ym6emrmd8u62yqu8\x1b[0m
  Print full output of recorded session:
    \x1b[1masciicam cat demo.cast\x1b[0m

For help on a specific command run:
  \x1b[1masciicam <command> -h\x1b[0m""",  # noqa: E501
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    parser.add_argument(
        "--version", action="version", version=f"asciicam {__version__}"
    )
    ...
    parser_upload = subparsers.add_parser(
        "upload", help="Upload locally saved terminal session to asciicam.org"
    )
    ...
    parser_auth = subparsers.add_parser(
        "auth", help="Manage recordings on asciicam.org account"
    )
